        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {skills.map((skillCategory) => (
            <Card
              ...
              className="bg-white/30 backdrop-blur-sm p-6 shadow-lg rounded-2xl"
            >
...
function TensorflowIcon() {
    return (
        <svg viewBox="0 0 24 24" className="w-12 h-12">
            <path fill="#ff6f00" d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm-1 15v-2h2v2zm-2-4l-1.42-1.41L12 13.17l-1.42-1.41L9.17 13l2.83 2.83zm4-3.17L12 6.83l-2.83 2.83L7.76 8.24L12 4l4.24 4.24z"/>
        </svg>
    )
}
